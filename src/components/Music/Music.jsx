            ...
            <div className="main">
                ...
                <div className="dashboardMain">
                    ...
                    <div className="tab_Links">
                        <Link className="tab_link active" to='/music'>Songs</Link>
                        <Link className="tab_link" to='/piano'>Piano Lessons</Link>
                    </div>
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-4">
                            <div className="musicCard">
                                <div className="musicCardImg">
                                    <img src="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bXVzaWN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />
                                </div>
