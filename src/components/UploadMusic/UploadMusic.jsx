        ...
        <div className="dashboard">
            ...
            <div className="main">
                ...
                <div className="dashboardMain">
                    ...
                    <h5 className='mb-5'>Add New Music</h5>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-12 mt-5">
                                <Form.Group className="mb-5" controlId="exampleForm.ControlInput1">
                                    <Form.Label className="inputLabel">Music Title</Form.Label>
                                    <Form.Control type="text" placeholder="Music Title" />
                                </Form.Group>


                                <Form.Group className="mb-5" controlId="exampleForm.ControlTextarea1">
                                    <Form.Label className="inputLabel">Music Description</Form.Label>
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-12 mt-2">
                                <Form.Group controlId="formFile" className="mb-3">
                                    <Form.Label className="inputLabel">Upload Music File</Form.Label>
                                    <Form.Control type="file" />
                                </Form.Group>

                            </div>
                            <div className="col-sm-12 col-md-12 col-lg-12 mt-2">
                                <button className="btn btn-custom">Upload Music</button>
